	...
	final class Restrict_Content_Pro {
		...
		private function setup_constants() {
			...
			if ( ! defined( 'RCP_PLUGIN_VERSION' ) ) {
				define( 'RCP_PLUGIN_VERSION', '3.5.13' );
			}
		...
		private function include_files() {
			...
			if ( defined( 'WP_CLI' ) && WP_CLI ) {
				...
				require_once( RCP_PLUGIN_DIR . 'includes/membership-levels/membership-level-commands.php' );
			}
			...
			// block functions
			require_once RCP_PLUGIN_DIR . 'includes/block-functions.php';
